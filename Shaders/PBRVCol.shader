    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 _BumpMap_var = UnpackScaleNormal(tex2D(_BumpMap,TRANSFORM_TEX(i.uv0, _BumpMap)), UNITY_ACCESS_INSTANCED_PROP( Props, _NormalStrength ));
...
///////// Gloss:
                ...
                float perceptualSmoothness = 1.0 - _Gloss_var;
...
////// Specular:
                ...
                float _Metallic_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Metallic) * tex2D(_MetallicTex,TRANSFORM_TEX(i.uv0, _MetallicTex));
                float3 specularColor = _Metallic_var;
                float specularMonochrome;
                float4 _Color_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Color );
                float3 diffuseColor = _MainTex_var.rgb * _Color_var.rgb * i.vertexColor;
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float4 _Color_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Color );
                float3 diffColor = _MainTex_var.rgb * _Color_var.rgb * i.vertexColor;
                float specularMonochrome;
                float3 specColor;
                float _Metallic_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Metallic) * tex2D(_MetallicTex,TRANSFORM_TEX(i.uv0, _MetallicTex));
                ...
                float Smoothness = 1 - (_Gloss_var * _MainTex_var.a);
